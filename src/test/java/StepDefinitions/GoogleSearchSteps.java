...
public class GoogleSearchSteps {
	 ...
	 * user_is_on_google_search_page() { driver.navigate().to("https://google.com");
	 * }
	 * 
	 * @When("user enters a text in search box") public void
	 * user_enters_a_text_in_search_box() {
	 * driver.findElement(By.name("q")).sendKeys("Kimetsu no Yaiba"); }
	 * 
	 ...
	 * driver.getPageSource().contains("Demon Slayer"); driver.close();
	 * driver.quit(); }
	 */
}
